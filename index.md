...
`May 2020 - current`
__Multiple repos to mono repo with CI__ *| YouSee*
...
`Feb 2020 - May 2020`
__Infrastructure and DevOps for streaming web app__ *| YouSee*
...
`Jun 2019 - May 2020`
__System for collecting royalties on TV ads__ *| Trackbit*
...
`Jun 2019 - Oct 2019`
__Javascript UI library for Spark browser__ *| YouSee*
...
`Sep 2018 - Feb 2019`
__Open source cryptocurrency trading bot__ *| Open source project*
...
`Sep 2018 - Feb 2019`
__Open source player implementation__ *| YouSee*
...
`Jun 2018 - Oct 2018`
__Art magazine website and admin backend__ *| Canvas post*
...
`Sep 2017 - Mar 2018`
__Whitelabel of existing streaming platform__ *| YouSee*
...
`Jun 2017 - Oct 2017`
__new Chromecast receiver app *| YouSee*
...
`Jan 2017 - Jun 2017`
__Website, app and backend for insurance startup__ *| Gigga*
...
`Mar 2017 - May 2017`
__Web crawler for collecting auto parts__ *| Navo*
...
`Mar 2016 - Apr 2016`
__Website for restaurant__ *| Sankt gertuds kloster*

Website built using React, HTML5 and CSS3 for a new restaurant.


`Nov 2016 - May 2017`
__Reminding app for iOS and Android__ *| Luapa*
...
`Oct 2016 - Feb 2017`
__Wine sales app, backend and invoice system__ *| Fine wine invest*
...
`Nov 2015 - Juli 2018`
__Web scraper for Copenhagen Capacity__ *| Copenhagen Capacity*
...
`Oct 2014 - Apr 2018`
__Housing association platform__ *| Fioniahus*
